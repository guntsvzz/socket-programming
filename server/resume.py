...
from parser.extractor_resume import extractor
...
def handle_upload_resume(body):
    ...
    user_data['resume'] = resume_content
    
    # Save the updated data back to the file
    with open(file_path, 'w') as f:
        json.dump(user_data, f, indent=4)
    
    return "200 OK", f"Resume uploaded successfully and extracted data done for user {username}."
